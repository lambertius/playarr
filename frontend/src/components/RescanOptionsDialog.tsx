      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div className={`space-y-2 rounded-lg border border-surface-border/50 p-3 ${fromDisk ? "opacity-40 pointer-events-none" : ""}`}>
            ...
            <ToggleRow label="Retrieve from TMVDB" description="Retrieve field-level candidates from The Music Video DB. Existing conflicts remain unchanged until reviewed." checked={scrapeTmvdb} onChange={(v) => { setScrapeTmvdb(v); if (v) { setAiAuto(false); setAiOnly(false); setFromDisk(false); } }} />
