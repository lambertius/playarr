...
Playarr 1.11 removes the Playarr Kodi add-on, its download and export APIs, and
the bundled plug-in assets. This does not delete media, NFO sidecars or artwork;
