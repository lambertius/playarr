# AUTO-SEPARATED from matching/candidates.py for pipeline_url pipeline
...
def _get_mb_provider():
    ...
    from app.pipeline_url.metadata.providers.musicbrainz import MusicBrainzProvider
    return MusicBrainzProvider()


def _get_wiki_provider():
    from app.pipeline_url.metadata.providers.wikipedia import WikipediaProvider
