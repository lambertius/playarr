# AUTO-SEPARATED from matching/resolver.py for pipeline_url pipeline
...
from app.pipeline_url.matching.normalization import (
...
from app.pipeline_url.matching.candidates import (
...
from app.pipeline_url.matching.scoring import (
...
from app.pipeline_url.matching.hysteresis import should_update_match, is_pinned
...
def _score_and_rank_artists(
    ...
    for c in artist_candidates:
        ...
        from app.pipeline_url.matching.scoring import _weighted_category_score, _ARTIST_FEATURE_WEIGHTS
...
def _score_and_rank_releases(
    ...
    for c in release_candidates:
        ...
        from app.pipeline_url.matching.scoring import _weighted_category_score, _RELEASE_FEATURE_WEIGHTS
...
def resolve_video(
    ...
    *,
    ...
    from app.pipeline_url.matching.models import (
    ...
    if top_recording and has_album:
        ...
        if top_recording.raw and top_recording.raw.get("album"):
            ...
            if album_key and mb_album_key == album_key:
                ...
                from app.pipeline_url.matching.scoring import string_similarity
...
def _match_result_to_output(mr, *, changed: bool) -> ResolveOutput:
    ...
    from app.pipeline_url.matching.models import MatchCandidate
