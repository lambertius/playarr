# AUTO-SEPARATED from ai/scene_analysis.py for pipeline_url pipeline
...
def _save_as_video_thumb(db: Session, video: VideoItem, thumb: AIThumbnail):
    ...
    from app.pipeline_url.services.artwork_service import validate_file as _validate_thumb
