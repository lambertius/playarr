# AUTO-SEPARATED from services/canonical_track.py for pipeline_url pipeline
# This file is independent â€” changes here do NOT affect the other pipeline.
"""
Canonical Track Service â€” Link/create canonical tracks for videos.

Core logic for the three-level metadata model (Artist â†’ Canonical Track â†’ Video).
...
def find_canonical_track(
    ...
    *,
    ...
    """
    # 1. MusicBrainz recording ID â€” strongest identifier
    if mb_recording_id:
...
def get_or_create_canonical_track(
    ...
    *,
    ...
    Returns (track_entity, created) â€” where created is True if a new
...
def link_video_to_canonical_track(
    ...
    Does NOT copy the description/plot â€” that remains video-specific.
    """
    ...
    # field is empty â€” the import pipeline's final_artist/final_title
