# AUTO-SEPARATED from services/artwork_manager.py for pipeline_url pipeline
# This file is independent â€” changes here do NOT affect the other pipeline.
"""
Artwork Manager â€” Kodi-compatible Artist/Album folder and artwork generation.
...
Manages the folder hierarchy Kodi expects for music-video library artwork:
    ...
    â”‚           â”œâ”€â”€ poster.jpg
    â”‚           â””â”€â”€ album.nfo
    â””â”€â”€ ArtistName - Title [1080p]/           â† existing video folders
        â”œâ”€â”€ ArtistName - Title [1080p].mkv
        â”œâ”€â”€ ArtistName - Title [1080p].nfo
        â”œâ”€â”€ poster.jpg
        â””â”€â”€ thumb.jpg

The _artists and _albums directories live inside the library_dir.
Kodi doesn't scan these directly â€” the artist/album info is picked up
...
def ensure_album_artwork(
    ...
    # Album poster (1000Ã—1000 â€” square)
    if download_and_save(image_url, poster_path,
...
def process_artist_album_artwork(
    ...
    if album:
        ...
        try:
            ...
            # CoverArtArchive direct ID lookup as FALLBACK only â€” the name-based
        ...
        _log("No album info â€” skipping album artwork")
